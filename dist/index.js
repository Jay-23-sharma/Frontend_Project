...
const settgBtn = document.querySelector("#settingsBtn");
const modalAI = document.querySelector("#modalAI");
const chatBtn = document.querySelector("#aiBtn");
...
let documents = documentsValue !== null ? JSON.parse(documentsValue) : [];
let editingId = null;
...
function addDocuments() {
    ...
    filteredDocuments.forEach((doc) => {
        ...
        const pendingText = doc.status === "pending" ? getPendingText(doc.pendingCount) : "";
        row.innerHTML = `
        <td>
          <input
            type="checkbox"
